...
class 뱀게임_클래스():
    ...
    def 제어_그리기(self,리스트):
        for 값,위치 in 리스트:
            # 도너트형 원 그리기.
            self.게임.draw.circle(self.화면, (51,0,51),위치,10,2)
            # 내부채운 원 그리기.
...
while True :
    ...
    for i in range(뉴런.입력개수):
        뱀게임.게임.draw.circle(뱀게임.화면, (255,255,255),(400,200+i*30),10,2)
    for i in range(뉴런.뉴런개수):
        뱀게임.게임.draw.circle(뱀게임.화면, (255,255,255),(800,200+i*30),10,2)
    for i in range(뉴런.뉴런개수):
        뱀게임.게임.draw.circle(뱀게임.화면, (255,255,255),(900,200+i*30),10,2)
    for i in range(뉴런.뉴런개수):
        뱀게임.게임.draw.circle(뱀게임.화면, (255,255,255),(1000,200+i*30),10,2)
    for i in range(뉴런.출력개수):
        뱀게임.게임.draw.circle(뱀게임.화면, (255,255,255),(1100,200+i*30),10,2)


    뱀게임.게임.draw.circle(뱀게임.화면, (입력[0]/3,100,100),(400,200),8)
    뱀게임.게임.draw.circle(뱀게임.화면, (입력[1]/3,100,100),(400,200+30),8)

    뱀게임.게임.draw.circle(뱀게임.화면, (입력[2]/3,100,100),(400,200+60),8)
    뱀게임.게임.draw.circle(뱀게임.화면, (입력[3]/3,100,100),(400,200+90),8)

    뱀게임.게임.draw.circle(뱀게임.화면, ((입력[4]+1)*100,100,100),(400,200+120),8)
    뱀게임.게임.draw.circle(뱀게임.화면, ((입력[5]+1)*100,100,100),(400,200+150),8)
