...
class 뱀게임_클래스():
    ...
    def 게임_구동(self):
        while True :
            ...
            self.게임.draw.line(self.화면, (120,22,225), [0,200], [600,200],5)
            self.게임.draw.line(self.화면, (110,11,111), [600,200], [600,800],5)
            self.게임.draw.line(self.화면, (170,17,177), [0,200], [0,800],5)
            self.게임.draw.line(self.화면, (120,22,202), [0,800], [600,800],5)
